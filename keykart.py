...
def shop_window(user):
    ...
    tk.Button(shop, text="Logout", font=FONT_BTN, bg="#e84c4c", fg="white",
          activebackground="#c9302c", command=lambda: (shop.destroy(), login_window())).pack(pady=5)
...
def admin_panel(user):
    ...
    tk.Button(admin, text="Logout", font=FONT_BTN, width=15, bg="#e84c4c", fg="white",
          activebackground="#c9302c", command=lambda: (admin.destroy(), login_window())).pack(pady=5)
